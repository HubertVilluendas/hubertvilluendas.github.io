...
\\(\min_{z\,\in\,\mathcal{Z}}\sup_{\substack{\mathbb{Q}\,\in\,\mathrm{Proba}\left(\Xi\right)\\ W_c(\Q,\widehat{\mathbb{P}}_N)\,\leq\,\varrho}}\mathbb{E}_{\zeta\sim\mathbb{Q}}\left[f(z,\zeta)\right]\\)

where \\(W_c(\cdot,\cdot)\\) denotes the Wasserstein distance [[Cuturi and Peyré](https://arxiv.org/pdf/1803.00567)], defined as

\\(W_c\left(\mathbb{Q}_1,\mathbb{Q}_2\right)\eqdef\inf_{\substack{\pi\,\in\,\mathrm{Proba}\left(\Xi\times\Xi\right)\\ [\pi]_1=\mathbb{Q}_1\, [\pi]_2=\mathbb{Q}_2}}\int_{\Xi\times\Xi}c\left(\xi,\xi'\right)\mathrm{d}\pi\left(\xi,\xi'\right).\\)
...
\\(\min_{z\,\in\,\mathcal{Z}}\min_{\lambda\geq 0}\left[F(z,\lambda)\overset{\text{\tiny def\normalsize}}{=}
\lambda\varrho+\varepsilon{\mathbb{E}}_{\xi\sim\widehat{\mathbb{P}}_N}\left[\log\left({\mathbb{E}}_{\zeta\sim\normal{\xi}{\sigma^2\mathbf{I}}}\left[\exp\left(\dfrac{f(z,\zeta)-\lambda c\left(\xi,\zeta\right)}{\varepsilon}\right)\right]\right)\right]
\right].\\)
